...
import { useFetchCategoriesQuery } from "../redux/api/categoryApiSlce"
  ...
  return (
   <>
        ...
        <div className="flex md:flex-row">
          <div className="bg-[#151515] p-3 mt-10 mb-2 ">
            ...
            <h2 className="h4 text-center py-2 text-white rounded-full mb-2">
              Filter by Brands
            </h2>
